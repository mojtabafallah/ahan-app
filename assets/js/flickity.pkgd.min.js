    ...
    return (
        ...
        (e.emitEvent = function(t, e) {
            ...
            if (i && i.length) {
                (i = i.slice(0)), (e = e || []);
                for (
                    var n = this._onceEvents && this._onceEvents[t], s = 0; s < i.length; s++
                ) {
                    var o = i[s];
...
(function(t, e) {
    ...
    function x(t) {
        if (
            ...
            for (
                var n = (i.isBorderBox = "border-box" == e.boxSizing), s = 0; s < b; s++
            ) {
                var o = y[s],
                    r = e[o],
                    a = parseFloat(r);
            ...
            if (e) {
                ...
                if (
                    (this.selectCell(o, !1, t),
                        this.removeNavSelectedElements(), !(o >= this.cells.length))
                ) {
